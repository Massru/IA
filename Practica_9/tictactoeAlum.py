...
def heuristica(nodo):
    ...
    for i in range(nodo.N):
        if (nodo.tablero[i, 0] == 0 or nodo.tablero[i, 0] == 1) and (nodo.tablero[i, 1] == 0 or nodo.tablero[i, 1] == 1) and (nodo.tablero[i, 2] == 0 or nodo.tablero[i, 2] == 1):
            winMAX += 1
        elif (nodo.tablero[i, 0] == 0 or nodo.tablero[i, 0] == -1) and (nodo.tablero[i, 1] == 0 or nodo.tablero[i, 1] == -1) and (nodo.tablero[i, 2] == 0 or nodo.tablero[i, 2] == -1):
            winMIN += 1

    for i in range(nodo.N):
        if (nodo.tablero[0, i] == 0 or nodo.tablero[0, i] == 1) and (nodo.tablero[1, i] == 0 or nodo.tablero[1, i] == 1) and (nodo.tablero[2, i] == 0 or nodo.tablero[2, i] == 1):
            winMAX += 1
        elif (nodo.tablero[0, i] == 0 or nodo.tablero[0, i] == -1) and (nodo.tablero[1, i] == 0 or nodo.tablero[1, i] == -1) and (nodo.tablero[2, i] == 0 or nodo.tablero[2, i] == -1):
            winMIN += 1

    if (nodo.tablero[0, 0] == 0 or nodo.tablero[0, 0] == 1) and (nodo.tablero[1, 1] == 0 or nodo.tablero[1, 1] == 1) and (nodo.tablero[2, 2] == 0 or nodo.tablero[2, 2] == 1):
        winMAX += 1
    elif (nodo.tablero[0, 0] == 0 or nodo.tablero[0, 0] == -1) and (nodo.tablero[1, 1] == 0 or nodo.tablero[1, 1] == -1) and (nodo.tablero[2, 2] == 0 or nodo.tablero[2, 2] == -1):
        winMIN += 1

    if (nodo.tablero[0, 2] == 0 or nodo.tablero[0, 2] == 1) and (nodo.tablero[1, 1] == 0 or nodo.tablero[1, 1] == 1) and (nodo.tablero[2, 0] == 0 or nodo.tablero[2, 0] == 1):
        winMAX += 1
    elif (nodo.tablero[0, 2] == 0 or nodo.tablero[0, 2] == -1) and (nodo.tablero[1, 1] == 0 or nodo.tablero[1, 1] == -1) and (nodo.tablero[2, 0] == 0 or nodo.tablero[2, 0] == -1):
        winMIN += 1
